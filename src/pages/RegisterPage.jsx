...
export const RegisterPage = () => {
    ...
    const [avatarUrl, setAvatarImage] = useState('') // Состояние для хранения выбранного изображения
    ...
    const handleSubmit = () => {
        try {
            ...
            setEmail('');
            setLogin('');
            setAvatarImage(null); // Сброс выбранного изображения после отправки формы
        } catch (error) {
            console.log(error);
        }
    };
